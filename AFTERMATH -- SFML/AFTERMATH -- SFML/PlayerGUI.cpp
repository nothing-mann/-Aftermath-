...
void PlayerGUI::initLevelBar()
{
	...
	this->levelBarText.setCharacterSize(32);
...
void PlayerGUI::initEXPBar()
{
	...
	this->expBarText.setCharacterSize(24);
	this->expBarText.setPosition(this->expBarInner.getPosition().x + 50.f, this->expBarInner.getPosition().y - 5.f);
}
...
void PlayerGUI::initHPBar()
{
	...
	this->hpBarText.setCharacterSize(24);
	this->hpBarText.setPosition(this->hpBarInner.getPosition().x + 50.f, this->hpBarInner.getPosition().y - 5.f);
}
