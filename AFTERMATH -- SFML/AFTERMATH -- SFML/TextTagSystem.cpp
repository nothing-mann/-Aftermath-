...
{
	this->tagTemplates[DEFAULT_TAG] = new TextTag(this->font, "", 200.f,200.f,0.f,-1.f,sf::Color::White, 40, 100.f, 200.f);
	this->tagTemplates[NEGATIVE_TAG] = new TextTag(this->font, "", 200.f, 200.f, 0.f, 1.f, sf::Color::Red, 40, 100.f, 250.f);
	this->tagTemplates[EXPERIENCE_TAG] = new TextTag(this->font, "", 200.f,200.f,0.f,-1.f,sf::Color::Yellow, 50, 150.f, 250.f);
	this->tagTemplates[POSITIVE_TAG] = new TextTag(this->font, "", 200.f, 200.f, 0.f, -1.f, sf::Color::Green, 50, 150.f, 250.f);
}
